...
function SetUseEffect(p) {
  ...
  useEffect(() => {
    ...
    pushArray.length && p.settotalNumbers(pushArray.length)
    pushArray2.length && p.settotalNumbers2(pushArray2.length)
    pushArray3.length && p.settotalNumbers3(pushArray3.length)
    pushArray4.length && p.settotalNumbers4(pushArray4.length)
    pushArray5.length && p.settotalNumbers5(pushArray5.length)
    pushArray6.length && p.settotalNumbers6(pushArray6.length)
    pushArray7.length && p.settotalNumbers7(pushArray7.length)
